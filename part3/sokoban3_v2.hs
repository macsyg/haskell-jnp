...
main = runActivity (resettable (withStartScreen (Activity initialState handleEvent draw)))
...
-- ekrany informacyjne END

-- opakowania rozszerzające activity
...
-- opakowania rozszerzające activity END
